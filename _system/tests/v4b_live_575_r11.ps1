...
Assert-R11 ([int]$slotPlan.reference_proxy_max_edge -eq 320) '575 detail1 must use 320px output proxy'
Assert-R11 ([int]$slotPlan.reference_proxy_stage_edge -eq 64) '575 detail1 must use 64px intermediate proxy'
...
Assert-R11 ([IO.Path]::GetFileNameWithoutExtension($runtimeRefs[0]) -match '_(safe|textshield)$') '575 detail1 must use text-shield proxy'
