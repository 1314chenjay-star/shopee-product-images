...
# Vehicle-seat use is secondary; the primary product is a sports sweat towel.
Assert-Route '47515735339' '運動吸汗毛巾 健身跑步擦汗巾 柔軟加厚多用途毛巾 車用座椅鋪巾' 'Sports & Outdoors/Badminton/Others' 'sports' 'sports_accessory'
